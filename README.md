...
1. Clone this project by using ```git clone https://github.com/DayVee-Programming/Dash-Stack.git``` on your command line or you can download it by pressing on 'Code' button --> 'Download ZIP'
